...
- Valor presente, valor actual neto (VAN)
- Tasa interna de retorno (TIR)
- Payback
- Tasa de descuento

## Unidad II: Rol Financiero en la empresa actual

- Ventajas de la administración financiera
- Proyección de flujos (Flujo de cajas)
- Activos Financieros
- Activos de Renta Fija y Variable
- Riesgo y Costo de Oportunidad del Capital
- Evaluación económica

## Unidad III: Decisiones de financiamiento

- Objetivos y decisiones financieras
- Evaluación económica
- Decisiones de financiamiento (corto, mediano y largo plazo); (palanca financiera)
- Costo de capital
- Planificación de corto y largo plazo

## Unidad IV: Cálculos financieros

- Capacitación software Microsoft Excel
- Casos de estudio en ejercicios aplicados
